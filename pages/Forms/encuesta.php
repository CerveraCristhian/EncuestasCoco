...
?>
                  ...
                  <label for="id_sucursal">Sucursal</label><select id="cmbSucursal" class="form-control" ng-model="sucursalSelected"
                    ng-options="sucursal.nombre for sucursal in sucursal.sucursal"> </select>
                  ...
                  <select id="cmbRecompensa" class="form-control" ng-model="recompensaSelected" ng-options="recompensas.descripcion for recompensas in recompensas.recompensas">
                </select>
