...
{
$consulta = "select d.id_pregunta, d.descripcion,c.descripcion as Respuesta,f.id_encuesta, count(*) as Count, f.emailenvio from encuesta_contestada as a join respuestas_contestadascliente as b
...
public static function GetEncuestaByID($id_encuesta)
{
